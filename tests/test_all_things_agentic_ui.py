...
class AllThingsAgenticUiTests(unittest.TestCase):
    ...
    def test_visual_storyboard_is_validated_hydrated_privately_and_grouped_for_landscape_pdf(self) -> None:
        for marker in (
            ...
            "function normalizeVisualOwnerReview(value, shots)",
            "video-studio.visual-owner-review/v1",
            "pending_owner_review",
            "manual_story_anatomy_identity_continuity_composition",
            "detail_hand_or_foreground_anatomy_risk",
            "OWNER VISUAL REVIEW HOLD.",
            "technical package ready · owner visual review HOLD",
            "isRecord(job?.visual_storyboard)",
            "No validated visual-review manifest was returned",
            "fail-closed HOLD",
            "A prompt-risk flag is not an image detector",
            "PLAN ONLY · GENERATED PLANNING ILLUSTRATIONS · OWNER VISUAL REVIEW HOLD",
            "reject/regenerate malformed or disproportionate anatomy",
            "Download review-HOLD MP4",
            "VISUAL QUALITY HOLD",
            "-narrated-storyboard-pitch-owner-review-hold.mp4",
            "Visual pending",
    ...
    def test_primary_pitch_requires_complete_verified_cloud_mp4_and_all_private_visuals(self) -> None:
        for marker in (
            ...
            "The natural Google Cloud narration and MP4 appear only after every visual card passes the technical completion gate; owner visual review is still required.",
            "Technical cloud MP4 ready for owner review — VISUAL QUALITY HOLD:",
